...
const headerRedefinedLine = (copybookName, fieldName, redefinedField) => `           10 ${copybookName.toUpperCase()}-${fieldName.toUpperCase().padEnd(22)}REDEFINES ${copybookName.toUpperCase()}-${redefinedField.toUpperCase()}.\n`;
